...
const EXAMPLE_DATA: AuthApproveTableItem[] = [
...
export class AuthApproveTableDataSource extends DataSource<AuthApproveTableItem> {
  data: AuthApproveTableItem[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: AuthApproveTableItem[]): AuthApproveTableItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: AuthApproveTableItem[]): AuthApproveTableItem[] {
